...
import androidx.lifecycle.ViewModel
    ...
    var GamesList : MutableList<Games> = mutableListOf()
    init{
        GamesList.add(Games("CS:GO", "9.5/10", "The game pits two teams, Terrorists and Counter-Terrorists, against each other in different objective-based game modes. The most common game modes involve the Terrorists planting a bomb while Counter-Terrorists attempt to stop them, or Counter-Terrorists attempting to rescue hostages that the Terrorists have captured.", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIT6Si1R7c32nr0o1IaMkRLhFU3-ouACrtbS0E1YmjBNFpdV8mSmWiFCUbTEobAT3pSYU&usqp=CAU"))
            GamesList.add(Games("Hollow", "9/10", "Hollow Knight is a classically styled 2D action adventure across a vast interconnected world. Explore twisting caverns, ancient cities and deadly wastes; battle tainted creatures and befriend bizarre bugs; and solve ancient mysteries at the kingdom's heart.", "https://d2uym1p5obf9p8.cloudfront.net/images/games/5a6129c97f5f7"))
    ...
    lateinit var itemSelected: Games
